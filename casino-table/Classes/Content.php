...
class Content
{
    ...
    public function name()
    {
        ...
        if ($this->type == 'admin') {
            ...
            $content .= '<img class="th_name__img" src=' . $imgUrl . ' alt="' . $this->CasinosInfo->name . '">';
            $content .= '<input type="file" name="fileImg[]" >';
        } else {
    ...
    public function buttons()
    {
        if ($this->type == 'admin') {
            ...
            $content = '<a class="btn_casino" href="' . $this->CasinosInfo->casinoURL . '">В Казино</a>';
